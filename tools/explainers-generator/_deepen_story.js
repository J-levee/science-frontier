// 加深 33 个新专题的「科普故事」：3 个 section、每节 2-3 段、约 900-1200 字
// 结构：hook + 一(是什么/为何重要) + 二(机制+比喻) + 三(能做什么/卡在哪·未解) + 金句
// 保持不变：tech / related / ai / cardDesc / eyebrow / tags
const fs = require('fs');
const path = 'C:/Users/zyd/WorkBuddy/科学边界项目/_explainers_data.js';
let src = fs.readFileSync(path, 'utf8');

const DEEP = {

'black-hole': `<div class="hook">💡 光跑得最快，却仍有东西能把它"关"在里面——那就是黑洞。它不黑，只是连光都逃不出来，所以我们看不到它，只能看见它"吃掉"东西时溅起的火花。</div>
<div class="section">
...
'gravitational-waves': `<div class="hook">💡 宇宙里两个黑洞相撞，不会发出声音，却会让空间本身"抖"一下——这种时空的涟漪，就是引力波。人类等了整整一百年，才第一次"听"到它。</div>
<div class="section">
...
'cmb': `<div class="hook">💡 调收音机时偶尔会有"沙沙"的雪花噪点，其中有一小部分，是宇宙诞生 38 万年后留下的"第一缕光"——宇宙微波背景辐射。</div>
<div class="section">
...
'dark-matter': `<div class="hook">💡 你看到的星星、行星、你我，加起来只占宇宙的 5%。剩下约 27% 是一种我们"看不见、摸不着"，却用引力牢牢拽着星系的神秘东西——暗物质。</div>
<div class="section">
...
'hubble-tension': `<div class="hook">💡 同一片宇宙，用两种方法量出来的"膨胀速度"却对不上——这个叫"哈勃张力"的裂缝，可能正暗示着标准宇宙模型哪里漏了。</div>
<div class="section">
...
'exoplanets': `<div class="hook">💡 小时候抬头数星星，你会想：别的星星旁也有"地球"吗？今天我们已经确认了五千多颗"系外行星"——太阳系之外的世界，而且种类比科幻还离奇。</div>
<div class="section">
...
'high-temp-superconductor': `<div class="hook">💡 普通电线输电会发热、会浪费电。有一种材料却能做到"零电阻"、电流毫无损耗地流——这就是超导，而人类一直在追一个梦：让它别那么冷。</div>
<div class="section">
...
'topological-insulator': `<div class="hook">💡 有一种奇怪的材料：内部是绝缘体，电流却只能贴着表面跑——像一栋外墙导电、屋里断电的房子。这就是拓扑绝缘体。</div>
<div class="section">
...
'lithium-battery': `<div class="hook">💡 你的手机、电动车、笔记本，肚子里大多是一块锂电池。它体积小却能量密，靠的是锂离子在两层之间"来回搬家"。</div>
<div class="section">
...
'quantum-hall': `<div class="hook">💡 把电子关在极薄的一层里、再加强磁场和超低温，电阻会突然"跳"到某些固定值，分毫不差——这就是量子霍尔效应，连计量标准都靠它。</div>
<div class="section">
...
'graphene': `<div class="hook">💡 用铅笔在纸上划一道，掉下来的黑色粉末里，可能就有只有一层原子厚的"神奇材料"——石墨烯，它是人类造出的最薄、却极强的二维晶体。</div>
<div class="section">
...
'artificial-photosynthesis': `<div class="hook">💡 植物晒太阳就能把水和二氧化碳变成糖和氧气。人类想"偷师"这套手艺，造出人造光合作用——用阳光直接把二氧化碳变成燃料。</div>
<div class="section">
...
'crispr': `<div class="hook">💡 过去改一段基因像在图书馆里手工找一页书、用剪刀改一个字，极难。CRISPR 的出现，等于给科学家发了一把"带导航的剪刀"，能精准找到并剪断任意基因。</div>
<div class="section">
...
'mrna-vaccine': `<div class="hook">💡 传统疫苗常把"弱化病毒"打进去让身体记仇。mRNA 疫苗反其道而行——它不塞病毒，只塞一张"配方纸条"，教你的细胞自己造一小段病毒零件，让免疫系统先认个脸。</div>
<div class="section">
...
'dna-double-helix': `<div class="hook">💡 1953 年，两张皱巴巴的纸模型，揭示了生命最底层的"说明书"长什么样——DNA 双螺旋。它解释了遗传为何能精确传递。</div>
<div class="section">
...
'cancer-immunotherapy': `<div class="hook">💡 癌细胞是身体"自己人"叛变，免疫系统却常认不出或打不过。免疫疗法想做的，是把身体的警察重新武装起来。</div>
<div class="section">
...
'microbiome': `<div class="hook">💡 你身上和体内住着数以万亿计的细菌、真菌，数量堪比甚至超过自身细胞。这个"微生物组"，其实是身体的隐形器官。</div>
<div class="section">
...
'p-vs-np': `<div class="hook">💡 有些问题，验证一个答案很容易，却没人知道怎么快速"想出"答案——比如拼图。P vs NP 问的正是：这两件事，真的一样容易吗？</div>
<div class="section">
...
'riemann-hypothesis': `<div class="hook">💡 质数像随机数一样散布，却又藏着惊人的规律。黎曼假设想用一个公式，预测质数到底分布得有多"匀"。</div>
<div class="section">
...
'fourier-transform': `<div class="hook">💡 同一段音乐，用钢琴弹是用一个个音"拼"出来的。傅里叶变换说的就是：任何复杂波形，都能拆成一堆不同频率的正弦波。</div>
<div class="section">
...
'chaos-theory': `<div class="hook">💡 蝴蝶扇一下翅膀，真能让远方刮起台风吗？混沌理论说的不是魔法，而是一个事实：有些系统对初始条件极其敏感，差之毫厘谬以千里。</div>
<div class="section">
...
'rsa-crypto': `<div class="hook">💡 你上网付款、发密信，背后常有一把"公开的锁"——谁都能用它加密，却只有持私钥的人能解开。RSA 就是这种锁的数学原理。</div>
<div class="section">
...
'greenhouse-effect': `<div class="hook">💡 没它，地球会是零下 18 度的冰球；没管住它，地球又在发烧。温室效应，本是生命之福，也是今日之患。</div>
<div class="section">
...
'carbon-cycle': `<div class="hook">💡 碳是生命的骨架元素，它在大气、海洋、岩石、生物间不停旅行。这个"碳循环"一旦被打乱，气候就跟着失衡。</div>
<div class="section">
...
'plate-tectonics': `<div class="hook">💡 脚下的"大地"其实是一块块拼图，正以指甲生长的速度缓缓漂移。地震、火山、山脉，多半是它们互相推挤的副产品。</div>
<div class="section">
...
'el-nino': `<div class="hook">💡 太平洋每隔几年会"翻脸"：东边海水异常变暖，全球的雨带、旱涝、台风随之乱套。这就是厄尔尼诺。</div>
<div class="section">
...
'ozone-layer': `<div class="hook">💡 离地面 20—30 公里有层薄薄的臭氧，它默默挡住了太阳光里最伤人的紫外线——是地球的"防晒霜"。</div>
<div class="section">
...
'ocean-acidification': `<div class="hook">💡 大气里多出的 CO₂，约四分之一被海洋吞下——可这对海洋不是好事：海水正悄悄变酸，珊瑚和贝壳最先遭殃。</div>
<div class="section">
...
'deep-learning': `<div class="hook">💡 过去教电脑认猫，得先告诉它"猫有尖耳朵、胡须"；深度学习反过来——给它成千上万张猫图，它自己琢磨出"猫长什么样"。这股复兴，点燃了今天的 AI 时代。</div>
<div class="section">
...
'transformer-llm': `<div class="hook">💡 你正在和聊天机器人对话，它吐出的每个字都"像人"。背后撑起它的，是一个叫 Transformer 的结构——2017 年一篇论文，改写了整个 AI。</div>
<div class="section">
...
'rl-alphago': `<div class="hook">💡 围棋曾被认为电脑一百年也下不过人。2016 年，AlphaGo 赢了世界冠军——靠的不是死算，而是"边试边学"的强化学习。</div>
<div class="section">
...
'computer-vision': `<div class="hook">💡 你手机扫二维码、相册自动人脸分组、工厂用摄像头挑次品——背后都是计算机视觉，让机器"看懂"图像。</div>
<div class="section">
...
'cnn': `<div class="hook">💡 同是"看"图，为什么深度学习比老方法强那么多？关键角色常是卷积神经网络（CNN）——它模仿眼睛"局部感受、层层抽象"的方式。</div>
<div class="section">
...
// —— 应用：把每个 DEEP 故事替换进数据源对应 slug 的 story 块 ——
function applyStory(s, slug, story){
  const i = s.indexOf("slug:'" + slug + "'");
  if (i < 0) return { s, ok:false };
  const j = s.indexOf('story:', i);
  const k = s.indexOf('`', j);
  const l = s.indexOf('`,', k + 1);
  if (k < 0 || l < 0) return { s, ok:false };
  return { s: s.slice(0, k + 1) + story + s.slice(l), ok:true };
}
let okCount = 0;
const fail = [];
for (const [slug, story] of Object.entries(DEEP)) {
  const r = applyStory(src, slug, story);
  if (r.ok) { src = r.s; okCount++; } else fail.push(slug);
}
fs.writeFileSync(path, src, 'utf8');
console.log('已加深 story 的专题数:', okCount, '/', Object.keys(DEEP).length);
